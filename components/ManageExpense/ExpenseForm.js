...
function ExpenseForm({onCancel,onSubmit,submitButtonLabel,defaultValues}){
    ...
    function inputChangedHandler(inputIdentifier,entredValue){
        setInputs((curInputs)=>{
            return{
                ...curInputs,
    ...
    function submitHandler(){
        ...
        //const dateIsValid = !isNaN(parsedDate) && parsedDate.toString() !== 'Invalid Date';
    ...
    return(
        <View style={styles.form}>
            ...
            <Input invalid={!inputs.description.isValid}
             textInputConfig={{
                multiline:true,
